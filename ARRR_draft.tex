...
\begin{document}
	...
	* figure out the philosophy of science stuff that we like 
	...
	%TODO an example can strengthen this kind of abstract info and make it more concrete
	...
	%TODO can you say a bit about why we'd want to do this? other than "because science"? does this fit into a broader theory of language? communication?
	
	%TODO be more explicit about the Philosophy of science backing here
	...
	%TODO introduce the empirical observation by explaining the set-up and then move forward with this 
	...
	%TODO Mike would like a diagram or table or **something**
	
	%TODO precision and generalization
...
%TODO running example should reoccur here!
...
%TODO Gabe Doyle stuff
%TODO  kids egocentric, naive egocentrism, naive realism, lexical alignment, keysar

%TODO clarify wtf they would think mentalizing is unecessary and ego-centric as default

%TODO connect to the lexical side 
...
% TODO partner specific often thought to be some sort of social representation, not just priming, 
% TODO bring out that this is definitely in contrast to that above 
...
%TODO example or at least define/clarify
...
Questions around audience design are %TODO
...
%TODO clarify here that this supports social/mentalistic theory
...
%TODO make sure we've more explicitly said that we want computation or mathematical model of communication
...
%TODO who doesn't want to do a lit review of the developmental work here
...
%TODO see the worked out example, but de-compress this 
...
%TODO do we find this explanatory? what's needed? what's solved? 
...
%TODO mike is dubious about this for so-called "computational level" models or something
...
%TODO re-paragraphify this thing
...
%TODO Mike would like a better articulated model of  the relevance of this data
...
\subsection{Data side}
	...
	Another third approach is to push down a level of analysis and do empirical work looking at how utterances are produced rather than just recording what descriptions are produced. This might be especially useful for initial descriptions where the search problem is the hardest. %TODO spell out what the search problem is 
	
	\subsection{Theory side}
	
	%TODO unpack all of this a little more b/c it's hard to parse
	...
	%TODO ugh this is getting away from RSA though
	...
	%TODO
	%TODO WHAT'S THE CAUSAL MODEL SO I CAN HAVE A CUTE OVERVIEW DIAGRAM
