...
Another property of languages is that they tend to have highly combinatorial structures at multiple levels, which allows language users to express new concepts which is necessary to cope with the non-stationarity of the human world \cite{kirby2015}. %TODO reread
...
\cite{kirby2015} claims that across many language systems and subsystems, we are near the expressive/compressive trade-off space. %TODO reread kirby for actual examples 
...
\cite{gibson2019} argues that efficiency, complexity and learnability are collectively probably shaping things. %TODO reread 
